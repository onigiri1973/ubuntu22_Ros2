...
#include "livox_interfaces/msg/detail/custom_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const livox_interfaces::msg::CustomPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: points
  {
    ...
    for (size_t i = 0; i < size; i++) {
      livox_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  livox_interfaces::msg::CustomMsg & ros_message)
{
  ...
  // Member: points
  {
    ...
    for (size_t i = 0; i < size; i++) {
      livox_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        livox_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        livox_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_CustomPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = livox_interfaces::msg::CustomMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const livox_interfaces::msg::CustomMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<livox_interfaces::msg::CustomMsg *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_livox_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<livox_interfaces::msg::CustomMsg>()
{
  return &livox_interfaces::msg::typesupport_fastrtps_cpp::_CustomMsg__handle;
}
