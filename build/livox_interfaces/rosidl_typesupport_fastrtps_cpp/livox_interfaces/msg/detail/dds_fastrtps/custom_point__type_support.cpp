...
#include "livox_interfaces/msg/detail/custom_point__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = livox_interfaces::msg::CustomPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const livox_interfaces::msg::CustomPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<livox_interfaces::msg::CustomPoint *>(
    untyped_ros_message);
...
{
  return &livox_interfaces::msg::typesupport_fastrtps_cpp::_CustomPoint__handle;
}
