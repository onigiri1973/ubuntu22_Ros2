...
bool
livox_interfaces__msg__CustomPoint__are_equal(const livox_interfaces__msg__CustomPoint * lhs, const livox_interfaces__msg__CustomPoint * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
livox_interfaces__msg__CustomPoint__copy(
  const livox_interfaces__msg__CustomPoint * input,
  livox_interfaces__msg__CustomPoint * output)
{
  if (!input || !output) {
    return false;
  }
...
livox_interfaces__msg__CustomPoint__create()
{
  ...
  livox_interfaces__msg__CustomPoint * msg = (livox_interfaces__msg__CustomPoint *)allocator.allocate(sizeof(livox_interfaces__msg__CustomPoint), allocator.state);
  if (!msg) {
    return NULL;
  }
...
livox_interfaces__msg__CustomPoint__Sequence__init(livox_interfaces__msg__CustomPoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (livox_interfaces__msg__CustomPoint *)allocator.zero_allocate(size, sizeof(livox_interfaces__msg__CustomPoint), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  livox_interfaces__msg__CustomPoint__Sequence * array = (livox_interfaces__msg__CustomPoint__Sequence *)allocator.allocate(sizeof(livox_interfaces__msg__CustomPoint__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
livox_interfaces__msg__CustomPoint__Sequence__are_equal(const livox_interfaces__msg__CustomPoint__Sequence * lhs, const livox_interfaces__msg__CustomPoint__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!livox_interfaces__msg__CustomPoint__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
livox_interfaces__msg__CustomPoint__Sequence__copy(
  const livox_interfaces__msg__CustomPoint__Sequence * input,
  livox_interfaces__msg__CustomPoint__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(livox_interfaces__msg__CustomPoint);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    livox_interfaces__msg__CustomPoint * data =
      (livox_interfaces__msg__CustomPoint *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!livox_interfaces__msg__CustomPoint__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          livox_interfaces__msg__CustomPoint__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!livox_interfaces__msg__CustomPoint__copy(
