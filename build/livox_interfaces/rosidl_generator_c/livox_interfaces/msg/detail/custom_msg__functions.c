...
bool
livox_interfaces__msg__CustomMsg__are_equal(const livox_interfaces__msg__CustomMsg * lhs, const livox_interfaces__msg__CustomMsg * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // points
  if (!livox_interfaces__msg__CustomPoint__Sequence__are_equal(
...
bool
livox_interfaces__msg__CustomMsg__copy(
  const livox_interfaces__msg__CustomMsg * input,
  livox_interfaces__msg__CustomMsg * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // points
  if (!livox_interfaces__msg__CustomPoint__Sequence__copy(
...
livox_interfaces__msg__CustomMsg__create()
{
  ...
  livox_interfaces__msg__CustomMsg * msg = (livox_interfaces__msg__CustomMsg *)allocator.allocate(sizeof(livox_interfaces__msg__CustomMsg), allocator.state);
  if (!msg) {
    return NULL;
  }
...
livox_interfaces__msg__CustomMsg__Sequence__init(livox_interfaces__msg__CustomMsg__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (livox_interfaces__msg__CustomMsg *)allocator.zero_allocate(size, sizeof(livox_interfaces__msg__CustomMsg), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  livox_interfaces__msg__CustomMsg__Sequence * array = (livox_interfaces__msg__CustomMsg__Sequence *)allocator.allocate(sizeof(livox_interfaces__msg__CustomMsg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
livox_interfaces__msg__CustomMsg__Sequence__are_equal(const livox_interfaces__msg__CustomMsg__Sequence * lhs, const livox_interfaces__msg__CustomMsg__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!livox_interfaces__msg__CustomMsg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
livox_interfaces__msg__CustomMsg__Sequence__copy(
  const livox_interfaces__msg__CustomMsg__Sequence * input,
  livox_interfaces__msg__CustomMsg__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(livox_interfaces__msg__CustomMsg);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    livox_interfaces__msg__CustomMsg * data =
      (livox_interfaces__msg__CustomMsg *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!livox_interfaces__msg__CustomMsg__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          livox_interfaces__msg__CustomMsg__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!livox_interfaces__msg__CustomMsg__copy(
