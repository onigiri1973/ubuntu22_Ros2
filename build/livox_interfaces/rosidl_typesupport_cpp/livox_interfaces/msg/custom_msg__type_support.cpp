...
static const _CustomMsg_type_support_symbol_names_t _CustomMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, livox_interfaces, msg, CustomMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, livox_interfaces, msg, CustomMsg)),
  }
};
...
{
  return &::livox_interfaces::msg::rosidl_typesupport_cpp::CustomMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, livox_interfaces, msg, CustomMsg)() {
  return get_message_type_support_handle<livox_interfaces::msg::CustomMsg>();
}
