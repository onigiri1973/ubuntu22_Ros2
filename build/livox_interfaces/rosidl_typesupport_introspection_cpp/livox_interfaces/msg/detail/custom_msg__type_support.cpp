...
{
  new (message_memory) livox_interfaces::msg::CustomMsg(_init);
}

void CustomMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<livox_interfaces::msg::CustomMsg *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<livox_interfaces::msg::CustomPoint> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<livox_interfaces::msg::CustomPoint> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<livox_interfaces::msg::CustomPoint> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__CustomMsg__points(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const livox_interfaces::msg::CustomPoint *>(
    get_const_function__CustomMsg__points(untyped_member, index));
  auto & value = *reinterpret_cast<livox_interfaces::msg::CustomPoint *>(untyped_value);
  value = item;
}
...
void assign_function__CustomMsg__points(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<livox_interfaces::msg::CustomPoint *>(
    get_function__CustomMsg__points(untyped_member, index));
  const auto & value = *reinterpret_cast<const livox_interfaces::msg::CustomPoint *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CustomMsg_message_member_array[6] = {
  {
    ...
    offsetof(livox_interfaces::msg::CustomMsg, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(livox_interfaces::msg::CustomMsg, timebase),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(livox_interfaces::msg::CustomMsg, point_num),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(livox_interfaces::msg::CustomMsg, lidar_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(livox_interfaces::msg::CustomMsg, rsvd),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<livox_interfaces::msg::CustomPoint>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(livox_interfaces::msg::CustomMsg, points),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CustomMsg_message_members = {
  "livox_interfaces::msg",  // message namespace
  "CustomMsg",  // message name
  6,  // number of fields
  sizeof(livox_interfaces::msg::CustomMsg),
...
get_message_type_support_handle<livox_interfaces::msg::CustomMsg>()
{
  return &::livox_interfaces::msg::rosidl_typesupport_introspection_cpp::CustomMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, livox_interfaces, msg, CustomMsg)() {
  return &::livox_interfaces::msg::rosidl_typesupport_introspection_cpp::CustomMsg_message_type_support_handle;
}
