...
static const _CustomMsg_type_support_symbol_names_t _CustomMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, livox_interfaces, msg, CustomMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, livox_interfaces, msg, CustomMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, livox_interfaces, msg, CustomMsg)() {
  return &::livox_interfaces::msg::rosidl_typesupport_c::CustomMsg_message_type_support_handle;
}
