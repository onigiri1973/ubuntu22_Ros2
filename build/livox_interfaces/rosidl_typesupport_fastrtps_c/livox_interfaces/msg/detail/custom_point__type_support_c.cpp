...
#include "livox_interfaces/msg/detail/custom_point__rosidl_typesupport_fastrtps_c.h"
...
using _CustomPoint__ros_msg_type = livox_interfaces__msg__CustomPoint;
...
static uint32_t _CustomPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_livox_interfaces__msg__CustomPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = livox_interfaces__msg__CustomPoint;
    is_plain =
      (
...
static size_t _CustomPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_livox_interfaces__msg__CustomPoint(
