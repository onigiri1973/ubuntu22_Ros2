...
class Metaclass_CustomMsg(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('livox_interfaces')
        except ImportError:
            import logging
            import traceback
            ...
            from livox_interfaces.msg import CustomPoint
...
class CustomMsg(metaclass=Metaclass_CustomMsg):
    ...
    _fields_and_field_types = {
        ...
        'lidar_id': 'uint8',
        'rsvd': 'uint8[3]',
        'points': 'sequence<livox_interfaces/CustomPoint>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['livox_interfaces', 'msg'], 'CustomPoint')),  # noqa: E501
    )
